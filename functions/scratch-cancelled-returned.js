 ...
 * 
 * Queries Firestore (tiendapraxis) for all 'cancelled' and 'returned' / 'refunded'
 * / 'refund_pending' orders and produces a detailed breakdown by channel, month and reason.
 *
 * Run from: /Volumes/MacData/Projects/Eurollantas/Website/importadora-euro/functions/
 *   node scratch-cancelled-returned.js
 */
...
async function main() {
    ...
    console.log('\n=== QUERYING CANCELLED / RETURNED / REFUNDED ORDERS (tiendapraxis) ===\n');
