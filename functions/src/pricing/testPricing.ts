...
// Test Floor Price
const floor = PricingService.calculateFloorPrice(100, 1.2);
...
// 180 / 0.80 = 225
const finalList = PricingService.calculateFinalListPrice(100, 20, 50, 10, 0.15, 0.05);
...
const byVolume = PricingService.distributeInboundFreight(100, items, 'volume');
...
const byWeight = PricingService.distributeInboundFreight(50, items, 'weight');
