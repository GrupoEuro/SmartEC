...
export class BusinessAnalyticsService {
     ...
     */
    getTopProducts(limitCount: number = 10, startDate?: Date, endDate?: Date): Observable<AnalyticsTopProduct[]> {
    ...
    private async fetchTopProducts(limitCount: number, startDate?: Date, endDate?: Date): Promise<AnalyticsTopProduct[]> {
    ...
    private processTopProducts(snapshot: QuerySnapshot<DocumentData>, limitCount: number): AnalyticsTopProduct[] {
