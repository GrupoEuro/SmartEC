        ...
        @if (!isMobile) {
            <div class="user-menu-container">
                ...
                <div class="user-dropdown">
                    ...
                    @if (userRole !== 'CUSTOMER') {
                        ...
                        @if (isInAccountArea()) {
                            <a [routerLink]="['/']" (click)="onNavigated()" class="dropdown-item">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="dropdown-icon"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg> {{ 'NAVBAR.HOME' | translate }}
                            </a>
                        } @else {
                            <a [routerLink]="['/account']" (click)="onNavigated()" class="dropdown-item">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="dropdown-icon"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg> {{ 'NAVBAR.MY_ACCOUNT' | translate }}
                            </a>
                        }
                    }
            ...
            <div class="mobile-user-section">
                ...
                @if (userRole !== 'CUSTOMER') {
                    ...
                    @if (isInAccountArea()) {
                        <a [routerLink]="['/']" (click)="onNavigated()" class="mobile-menu-item">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="dropdown-icon"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg> {{ 'NAVBAR.HOME' | translate }}
                        </a>
                    } @else {
                        <a [routerLink]="['/account']" (click)="onNavigated()" class="mobile-menu-item">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="dropdown-icon"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg> {{ 'NAVBAR.MY_ACCOUNT' | translate }}
                        </a>
                    }
                }
...
export class NavbarUserWidgetComponent {
    ...
    get userRole(): string {
        return this.authService.currentProfile()?.role || 'CUSTOMER';
    }
