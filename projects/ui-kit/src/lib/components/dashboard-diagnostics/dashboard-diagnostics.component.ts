    ...
    <div class="debug-footer" [class.collapsed]="!isExpanded()">
        ...
        <div class="diagnostics-content" *ngIf="isExpanded()">
            <div class="diagnostics-info">
                ...
                <div class="info-row" *ngIf="dateRange">
                    <strong>Date Range:</strong> 
                    {{ dateRange.start | date:'short' }} - 
                    {{ dateRange.end | date:'short' }}
                </div>
            </div>
...
export class DashboardDiagnosticsComponent {
    ...
    // public contextService = inject(CommandCenterContextService); // Removed dependency
